#' ---
#' title: aula 02 - revisao de estrutura e manejo de dados
...
# 2. logical: assume apenas dois valores (booleano)
# logical
...
# 2. matrix: homogeneo (um modo) e bidimensional (duas dimensao)
