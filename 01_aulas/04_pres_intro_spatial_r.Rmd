...
background-image: url(img/genral_data_science.png)
...
# Mas antes, uma outra forma de indicar diretórios
...
```{r echo=FALSE}
si <- readr::read_csv("/home/mude/data/github/disciplina-analise-geoespacial/03_dados/ATLANTIC_AMPHIBIANS_sites.csv")
si
```
...
```{r,include=FALSE}
sp <- readr::read_csv("/home/mude/data/github/disciplina-analise-geoespacial/03_dados/ATLANTIC_AMPHIBIANS_species.csv")
sp
```
