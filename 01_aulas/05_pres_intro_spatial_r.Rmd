...
1. 5.5 Sistema de Informação Geográfica (SIG)
...
background-position: 30% 50%,80% 50%
...
**Converção**: não é trival e requer muita trigonometria - feita por computador
...
- 25L 232323, 4242424; WGS 84
- 25L 232323, 4242424; SIRGAS 2000

---

class: inverse, center, middle

# E se eu te disser que há códigos numéricos para cada SRC?
...
### Possui códigos numéricos para os CRS do mundo
...
## Tipos de dados em GPS

**1. Waypoints**: **ponto de interesse**, contendo longitude e latitude, além de informações como elevação, nome, descrição
...
# 5.13 Repositórios de dados geoespaciais
