...
## Dados de pacotes: rnaturalearth
```{r fig.align='center', fig.height=4, out.width='100%'}
# plot
...
```{r fig.align='center', fig.height=4, out.width='90%'}
# plot
...
### Mapa
```{r echo=FALSE, fig.align='center', fig.height=4, out.width='80%'}
library(tidyverse)
p1 <- ggplot() +
...
## 1. Subset espacial [] - fora - atente para a vírgula!
```{r}
# spatial subsetting - outside - comma!
