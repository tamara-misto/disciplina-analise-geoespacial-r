...
<br>
O R é uma **linguagem de programação livre** (*open source*), direcionada ao **manipulação, análise e visualização de dados**, com diversas **expansões** (*pacotes*) para o uso de **dados com formatos específicos** (**Maurício Vancine**)
